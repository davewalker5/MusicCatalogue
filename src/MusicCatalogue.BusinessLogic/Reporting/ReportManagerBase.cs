...
namespace MusicCatalogue.BusinessLogic.Reporting
{
    ...
    internal abstract class ReportManagerBase
    {
        ...
        protected ReportManagerBase(MusicCatalogueDbContext context)
        {
            _context = context;
        }
        ...
        /// <summary>
        /// Read a SQL query from an embedded resource
        /// </summary>
        /// <param name="file"></param>
        /// <param name="placeHolderValues"></param>
        /// <returns></returns>
        protected static string ReadSqlResource(string file, Dictionary<string, string> placeHolderValues)
        {
            ...
            var assembly = Assembly.GetExecutingAssembly();
            var sqlResourceName = $"MusicCatalogue.BusinessLogic.Sql.{file}";
