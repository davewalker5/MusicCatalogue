...
namespace MusicCatalogue.Api.Controllers
{
    ...
    public class ArtistMoodsController : Controller
    {
        ...
        public ArtistMoodsController(IMusicCatalogueFactory factory)
            => _factory = factory;
        ...
        {
            _factory.Logger.LogMessage(Severity.Debug, $"Adding artist/mood mapping {template}");
        ...
        {
            _factory.Logger.LogMessage(Severity.Debug, $"Deleting artist/mood mapping with ID {id}");
            ...
            if (mood == null)
            {
                _factory.Logger.LogMessage(Severity.Error, $"Artist/mood mapping with ID {id} not found");
                return NotFound();
            }
